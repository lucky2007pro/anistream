...
try:
    ...
    script = """
import psycopg2
conn = psycopg2.connect("postgresql://bestmedia_admin:hojiakbar_db_pass@127.0.0.1:5432/anistream")
...
conn.close()
"""
    cmd = f'cat << "EOF" > /opt/anistream/drop_db.py\n{script}\nEOF\n/opt/anistream/venv/bin/python /opt/anistream/drop_db.py'
